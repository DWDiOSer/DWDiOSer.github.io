...
<left>![image set up-w320](点我达骑手App降级方案/load.png)</left>
...
`a.免登情况，直接进入主页，如下图`
<left>![image set up-w320](点我达骑手App降级方案/order.png)</left>

`b.非免登情况，直接进入登录页，如下图`
<left>![image set up-w320](点我达骑手App降级方案/login.png)</left>
...
###### Hulk接口降级
<left>![image set up-w1024](点我达骑手App降级方案/hulk.png)</left>
...
###### Spider接口降级
<left>![image set up-w1024](点我达骑手App降级方案/spider1.png)</left>
...
```
### 附: 接口降级完整流程
<left>![image set up-w2048](点我达骑手App降级方案/request.png)</left>
